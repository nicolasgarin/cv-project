...
export default function Experience() {
  ...
  <li>
    ...
    <time className="font-mono italic">2021</time>
      <div className="text-lg font-black">Jóvenes a programar</div>
    </div>
    <hr />
  </li>
  <li>
  ...
  <li>
    ...
    <div className="timeline-end mb-10">
      <time className="font-mono italic">2012 - 2014</time>
      <div className="text-lg font-black">Supervisor sector cajas - Macromercado Mayorista</div>
    </div>
    <hr />
  </li>
  <li>
    ...
    <div className="timeline-start mb-10 md:text-end">
      <time className="font-mono italic">2003 - 2008</time>
      <div className="text-lg font-black">Bachillerato en Ingeniería</div>
