    ...
    <div id="sidebar" className="fixed h-screen w-96">
      <div className="info-container flex flex-col justify-center h-screen">
        <div className="info mb-28">
          <h1 className="text-5xl"><span className="text-sky-300 font-bold">N</span>icolás <span className="text-sky-300 font-bold">G</span>arín</h1>
          <h2 className="text-2xl mt-2">Desarrollador <span className="text-sky-300 font-bold">Front-end</span></h2>
